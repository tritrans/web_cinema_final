...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Chỉnh sửa rạp chiếu</h1>
            <p class="text-gray-600 mt-1">Cập nhật thông tin rạp chiếu "{{ $theater['name'] ?? 'N/A' }}"</p>
        </div>
    </div>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('admin.theaters.update', $theater['id']) }}" class="space-y-6">
        @csrf
        @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="tel" name="phone" value="{{ old('phone', $theater['phone'] ?? '') }}" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 outline-none"
                ...
                <div>
                    ...
                    <input type="text" name="address" value="{{ old('address', $theater['address'] ?? '') }}" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 outline-none"
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email', $theater['email'] ?? '') }}" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 outline-none"
                ...
                <div>
                    ...
                    <textarea name="description" rows="4" 
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 outline-none"
                              placeholder="Nhập mô tả về rạp chiếu">{{ old('description', $theater['description'] ?? '') }}</textarea>
                </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="toggle-switch">
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', $theater['is_active'] ?? true) ? 'checked' : '' }} 
                               id="is_active-toggle">
        ...
        <div class="flex items-start">
            ...
            <div>
                ...
                <p class="text-blue-800 text-sm">
                    Các trường có dấu (*) là bắt buộc. Thay đổi trạng thái hoạt động sẽ ảnh hưởng đến việc hiển thị rạp chiếu cho người dùng.
                </p>
            </div>
        </div>
    </div>
